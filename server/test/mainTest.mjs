    ...
    { 
        ...
        describe('Test the /recipes route API to get recipes from the web app', function()
        {
            ...
            {// ########################################## TEST /recipes/findByIngredients ##########################################
                it('Fail 1. Try to get recipes by ingredients with no ingredients.\n' +
                ...
                it('Fail 2. Try to get recipes by ingredients with an invalid ingredient.\n' +
                ...
                it('Pass 1. Try to get recipes by ingredients with valid ingredients.\n' +
            ...
            {// ########################################## TEST /recipes/findByType ##########################################
                it('Fail 1. Try to get recipes by type with no type.\n' +
                ...
                it('Fail 2. Try to get recipes by type with an invalid type.\n' +
                ...
                it('Pass 1. Try to get recipes by type with valid type.\n' +
                '           This test should pass with data in the response.data object.', 
                async function() {
